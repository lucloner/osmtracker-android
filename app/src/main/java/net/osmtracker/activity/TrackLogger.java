...
public class TrackLogger extends Activity {
     ...
     */
    private final ServiceConnection gpsLoggerConnection = new GPSLoggerServiceConnection(this);
    /*
     *  Avoid taking care of duplicated elements
     */
    private final HashSet<String> layoutNameTags = new HashSet<>();
    /**
    ...
    private void saveTagsForTrack() {
        ...
        if (previouslySavedTags != null) {
            tagsToSave.addAll(Arrays.asList(previouslySavedTags.split(TAG_SEPARATOR)));
        }
    ...
    protected void onPrepareDialog(int id, Dialog dialog) {
        if (id == DIALOG_TEXT_NOTE) {// we need to reset Values like uuid of the dialog,
